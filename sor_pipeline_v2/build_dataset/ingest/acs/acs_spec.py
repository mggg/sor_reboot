...
_B = Section(
    "B",
    "US Citizenship and Residency Status",
    (
        TableSpec(
            "B05003I",
            HISP,
...
_D = Section(
    ...
    (
        ...
        TableSpec(
            "B05005",
            "Foreign-born population (period of entry known)",
            False,
            (
                _f(
                    "FBENTERED2010PLUS",
        ...
        TableSpec(
            "B07004I",
            f"{HISP} 1 year and over",
            True,
            (
                _f(
                    "HISPMOVEDWITHINCOUNTY",
                    "B07004I",
                    "003",
                    "001",
...
_F = Section(
    ...
    (
        ...
        TableSpec(
            "B17001I",
            f"{HISP} for whom poverty status is determined",
            True,
            (
                _f(
                    "HISPPOVERTY",
        ...
        TableSpec(
            "B22005I",
            "Households with a Hispanic or Latino householder",
            True,
            (
                _f(
                    "HISPSNAP",
        ...
        TableSpec(
            "B25003I",
            "Occupied housing units with a Hispanic or Latino householder",
            True,
            (
                _f(
                    "HISPOWNEROCC",
...
_G = Section(
    ...
    (
        TableSpec(
            "C24010I",
            f"Civilian employed {HISP} 16 years and over",
            True,
            (
                _f(
                    "HISPOCCMGMT",
                ...
                _f(
                    "HISPOCCSERVICE", "C24010I", "004 010", "001", "Service occupations"
                ),
                _f(
                    "HISPOCCSALESOFFICE",
                    "C24010I",
...
_H = Section(
    "H",
    "Household Structure (Age, Marriage, Sex)",
    (
        TableSpec(
            "B01002I",
            HISP,
        ...
        TableSpec(
            ...
            (
                _f(
                    "HISPUNDER18",
                    "B01001I",
                    "003 004 005 006 018 019 020 021",
                    "001",
                    "Under 18 years",
                ),
                _f(
                    "HISP18TO34",
                    "B01001I",
                    "007 008 009 010 022 023 024 025",
                    "001",
                    "18 to 34 years",
                ),
                _f(
